...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ITrackable tacoBell1 = null; // TODO: Create two `ITrackable` variables with initial values of `null`. These will be used to store your two taco bells that are the farthest from each other.
            ITrackable tacoBell2 = null;
            double distance = 0.00;// Create a `double` variable to store the distance
            ...
            {    // Do a loop for your locations to grab each location as the origin (perhaps: `locA`)
                ...
                for (int j = i + 1; j < locations.Length; j++)
                {
                    ...
                    // var Getdistance = locations.GetDistanceTo(locB, corA);
